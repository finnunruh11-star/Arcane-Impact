...
static var HERO_ABILITIES: Array[Array] = [
	...
	[
		_ability(&"signature", "HEAVENFALL", ["Compact sky strike chains through four targets", "Wider Heavenfall chains through six targets", "Full huge-zone Heavenfall chains through ten targets", "Cathedral-sized impact removes the target limit", "Maximum reach drops an uncapped 500-radius thunderhead"]),
